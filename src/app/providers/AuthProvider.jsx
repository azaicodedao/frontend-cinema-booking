...
const AuthProvider = ({ children }) => {
  ...
  // Backend trả về role là string đơn "ADMIN" hoặc "CUSTOMER" (không phải mảng)
  const isAdmin = currentUser?.role === 'ADMIN';

  return (
    <AuthContext.Provider value={{ currentUser, setCurrentUser, login, logout, isAuthenticated, isAdmin }}>
      {children}
    </AuthContext.Provider>
  );
};
